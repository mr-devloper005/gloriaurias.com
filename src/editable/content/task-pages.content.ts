...
export const taskPageVoices = {
  ...
  sbm: {
    eyebrow: 'Resources · Curators',
    headline: 'Curated resources arranged like premium shelves.',
    description: 'Browse useful tools, references, links, and collections with calm metadata and clear source context.',
  ...
  profile: {
    ...
    headline: 'Direct identity records with trust and contact cues.',
    description: 'Identity records remain available only through direct URLs.',
